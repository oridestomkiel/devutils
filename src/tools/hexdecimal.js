const hexdecimal = {
  ...
  render: () => `
    ...
    <div class="relative">
      ...
      <button id="copyHexDec" class="absolute top-0 right-0 bg-gray-600 hover:bg-gray-500 px-2 py-1 rounded text-white">Copiar</button>
      <span id="copiedHexDec" class="absolute top-0 right-0 text-green-400 px-2 py-1 hidden">Copiado!</span>
    </div>
  `,
  init: () => {
