const uuid = {
  ...
  render: () => `
    ...
    <div class="relative mb-2">
      ...
      <button id="copyUuidBtn" class="absolute top-2 right-20 bg-gray-600 hover:bg-gray-500 px-2 py-1 rounded text-white">Copiar</button>
      <button id="downloadUuidBtn" class="absolute top-2 right-2 bg-gray-700 hover:bg-gray-600 px-2 py-1 rounded text-white">Baixar</button>
      <span id="copiedUuidMsg" class="absolute top-2 right-2 text-green-400 px-2 py-1 hidden">Copiado!</span>
    </div>
  `,
  init: () => {
